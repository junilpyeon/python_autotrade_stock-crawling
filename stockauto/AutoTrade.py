...
def get_target_price(code):  # junil 목표가
    """매수 목표가를 반환한다."""
    try:
...
if __name__ == '__main__':
    try:
        ...
        total_cash = int(get_current_cash())   # junil 100% 증거금 주문 가능 금액 조회
        buy_amount = total_cash * buy_percent  # junil 종목별 주문 금액 계산
        ...
        while True:
            ...
            t_start = t_now.replace(
                hour=9, minute=5, second=0, microsecond=0)  # junil
